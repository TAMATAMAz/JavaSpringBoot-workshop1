...
public class CustomerServiceTest {
    ...
    void  testUpdateCustomer(){
        ...
        reqCustomer.setFirstName("hine");
        reqCustomer.setLastName("wisuta");
        reqCustomer.setEmail("wisuta@test.com");
        reqCustomer.setPhoneNo("0912345679");
    ...
    void testUpdateCustomerFail(){
        ...
        reqCustomer.setEmail("janeNo@gmail.com");
    ...
    void testDeleteCustomer(){
        ...
        boolean resp = customerService.deleteById(resqId);
        assertTrue(resp);
    }
